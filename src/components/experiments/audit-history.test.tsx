...
it("labels steps carried forward without inventing a completion time", () => {
  const carriedForward: AuditEvent = {
    ...event,
    id: "a2",
    ...
    after: {
      ...
      carryForwardRecordedAt: "2026-07-31T10:00:00Z",
    },
  };
  const html = renderToStaticMarkup(<AuditHistory events={[carriedForward]} />);

  expect(html).toContain("ระบุว่าขั้นนี้ทำไปแล้ว");
