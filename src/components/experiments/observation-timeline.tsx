...
type ObservationTimelineProps = { observations: Observation[]; onDelete: (id: string) => Promise<void>; onEdit: (item: Observation) => void; onRestore: (id: string) => Promise<void> };
const metric = (value: number | null) => value === null ? "—" : String(value);
export function ObservationTimeline({ observations, onDelete, onEdit, onRestore }: ObservationTimelineProps) {
