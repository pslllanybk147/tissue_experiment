  ...
  return (
    <section style={{ marginTop: "24px" }}>
      ...
      <p className="pl-lede" style={{ marginTop: "12px" }}>
        ตารางนี้ใช้เมื่อคุณอยากลองสามความเข้มข้นพร้อมกันในรอบเดียว ไม่ใช่ช่องบังคับของขั้นนี้
      </p>
      <ul className="pl-meta" style={{ margin: "8px 0 0", paddingLeft: "20px" }}>
        <li>
          <strong>กรอกทีหลัง ไม่ใช่วันนี้</strong> — วันนี้แค่แบ่งชิ้นพืชเป็นสามชุดตามความเข้มข้นด้านล่าง
          แล้วรอครบ 14 วันค่อยกลับมาที่ขั้นนี้เพื่อนับกระปุกและกรอกสามช่องต่อชุด
        </li>
        <li>
          ต้องมีกระปุกอย่างน้อย <strong>3 ชุด × จำนวนกระปุกต่อชุด</strong> (ค่าเริ่มต้น 3 ใบต่อชุด = 9 ใบ)
          ถ้ากระปุกไม่พอ ให้ข้ามตารางนี้แล้วทำความเข้มข้นเดียวไปก่อน
        </li>
