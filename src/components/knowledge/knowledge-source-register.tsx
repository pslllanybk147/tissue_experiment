...
export function KnowledgeSourceRegister({ focusClaimId, records, sources, claims, onCreateSource, onCreateClaim, onReviewClaim, onDiscover }: Props) {
  ...
  return <section className="knowledge-sources" aria-label="Knowledge source registry">
    ...
    <div className="knowledge-source-grid">
      <form className="knowledge-form cl-atlas-form-section" onSubmit={submitSource}>
      ...
      <form className="knowledge-form cl-atlas-form-section" onSubmit={submitClaim}>
