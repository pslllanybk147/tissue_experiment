...
type Props = {
  ...
  onCreatePlaybookFromClaim?: (claimId: string) => Promise<void>;
  onDiscover: (identifier: string) => Promise<DiscoveredSourceMetadata>;
};

export function KnowledgeSourceRegister({ focusClaimId, records, sources, claims, onCreateSource, onCreateClaim, onReviewClaim, onCreatePlaybookFromClaim, onDiscover }: Props) {
