  ...
  const guidedSteps = useMemo(() => {
    ...
    try {
      ...
      const exactActions = [
        ...
        `เติมน้ำให้ปริมาตรสุดท้ายครบ ${recipePlan.volumeMl} mL แล้วเทลงภาชนะทนความร้อนที่มีพื้นที่ว่างเหนือของเหลว`,
        "วางภาชนะบนเตาให้ความร้อนระดับต่ำถึงปานกลาง ใช้แท่งแก้วคนต่อเนื่อง ห้ามเดินออกจากเตา",
        "ให้ความร้อนจนไม่เห็นเม็ดหรือก้อน agar เกาะแท่งแก้วและของเหลวสม่ำเสมอ หากฟองสูงใกล้ล้น ให้ปิดความร้อนและยกออกด้วยถุงมือกันความร้อน",
        ...(lot.sterilization.method === "haiter-chemical"
          ? [
              "ปิดคลุมภาชนะอย่างหลวมเพื่อกันฝุ่น แล้วใช้เทอร์โมมิเตอร์วัด รอให้อาหารลดลงถึง 55–60°C ก่อนเข้าสู่ขั้นเติม Haiter ห้ามเติมขณะอาหารร้อนกว่านี้",
              "เติม Haiter ตามปริมาตรที่ระบบคำนวณ คนให้ทั่ว แล้วแบ่งลงภาชนะที่ฆ่าเชื้อไว้ ปิดฝาและติดฉลากรหัส Lot สูตร ปริมาตร วันที่ และวิธี Haiter",
            ]
          : [
              "แบ่งอาหารที่วุ้นละลายแล้วลงภาชนะทนแรงดันตามปริมาตรต่อกระปุก ปิดฝาตามคู่มือภาชนะ ติดฉลากรหัส Lot สูตร ปริมาตร และวันที่ แล้วไปขั้นหม้อนึ่งแรงดัน",
            ]),
      ];
