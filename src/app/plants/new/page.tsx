...
export default function NewPlantPage() {
  ...
  const [value, setValue] = useState({ taxonId: undefined as string | undefined, sellerName: "", suspectedSpecies: "", identificationConfidence: "Unknown" as PlantRecord["identificationConfidence"], source: "", receivedAt: new Date().toISOString().slice(0, 10), health: "Healthy" as PlantRecord["health"], notes: "" }); const [error, setError] = useState("");
  // Query-string prefill is intentionally a suggestion; the user must confirm the identity and confidence.
