...
export const coreSteps: Record<string, ManualStepDef> = {
  ...
  "prep-tools": {
    ...
    materials: [
      ...
      "แอลกอฮอล์ 70 เปอร์เซ็นต์ใส่ภาชนะปากกว้างพอจุ่มเครื่องมือได้",
    ...
    actions: [
      ...
      "พ่นแอลกอฮอล์ 70 เปอร์เซ็นต์ให้ทั่วผนังในตู้ทำงาน แล้วเช็ดด้วยผ้าสะอาด",
  ...
  "prep-media": {
    ...
    actions: [
      ...
      "วัดค่า ppm ของน้ำที่จะใช้แล้วจดไว้ เพื่อให้เทียบได้เมื่อผลรอบต่อรอบไม่เหมือนกัน",
    ...
    measurements: [
      ...
      { id: "water-ppm", label: "ค่า ppm ของน้ำที่ใช้", unit: "count", required: false, min: 0 },
    ],
    evidence: {
      level: "adapted",
