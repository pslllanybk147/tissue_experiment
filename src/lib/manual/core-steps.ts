...
export const coreSteps: Record<string, ManualStepDef> = {
  ...
  identify: {
    ...
    actions: [
      "เทียบรูปใบและลายด่างของต้นจริงกับชื่อวิทยาศาสตร์และคำบรรยายพันธุ์ที่หัวคู่มือ",
      "ถ้าคู่มือมีลิงก์รูปอ้างอิงจากผู้ขาย ให้เปิดดูประกอบ เป็นรูปสินค้า ไม่ใช่หลักฐานทางวิชาการ",
      "เลือกระดับความมั่นใจในช่องบันทึกด้านล่างว่า มั่นใจ ไม่แน่ใจ หรือเดา",
      "ถ้าเลือก \"เดา\" ให้หยุดรอบนี้ไว้ก่อน แล้วไปหน้า \"ไล่ดูจากลักษณะต้น\" เพื่อหาคู่มือที่ตรงกว่า",
      "รอบที่สร้างแล้วเปลี่ยนคู่มือไม่ได้ ถ้าจะเปลี่ยนต้องเริ่มรอบใหม่ด้วยคู่มือกลางของสกุล",
    ],
  ...
  cut: {
    ...
    materials: [
      ...
      // ของสองอย่างนี้ต้องมีอยู่แล้วตอนเจออาการ ไม่ใช่ค่อยไปหาซื้อ จึงอยู่ในรายการของ
      // ของขั้นนี้แทนที่จะอยู่ในคำอธิบายเหตุผล วิธีใช้เต็มอยู่ในคลังอาการของขั้นนี้
      "[[ascorbic-acid|กรดแอสคอร์บิก]]และ[[citric-acid|กรดซิตริก]] ซื้อเตรียมไว้ก่อนลงมีด ใช้เมื่อรอยตัดเปลี่ยนเป็นสีน้ำตาลเข้ม",
    ],
    actions: [
  ...
  "prep-tools": {
    ...
    evidence: {
      ...
      note:
        "เป็นวิธีที่คลิปสาธิตของศูนย์ความเป็นเลิศด้านเทคโนโลยีชีวภาพพืช มหาวิทยาลัยราชภัฏเชียงใหม่ ใช้ทั้งกระบวนการ " +
  ...
  "prep-media": {
    ...
    actions: [
      ...
      "จดค่า TDS ของน้ำที่จะใช้ไว้ ใช้ค่าที่บันทึกไว้ในหน้า \"ของที่ฉันมี\" ได้เลย",
      "ไม่มีเครื่องวัด TDS ให้ข้ามช่องนี้ ไม่ใช่ช่องบังคับ และห้ามเอาค่าคลอรีนมากรอกแทน",
      ...
      "ทางเลือกทดลอง (ไม่ใช้หม้อนึ่ง): ผสม[[nadcc|NaDCC]]ลงในอาหารแทนการฆ่าเชื้อด้วยความร้อน",
      "ปริมาณ NaDCC ให้อ่านจากเครื่องคำนวณในขั้นนี้ ห้ามแปลงเม็ดเป็นมิลลิลิตรเอง",
      "ทางเลือกนี้ยังไม่มีตัวเลขยืนยันเจาะจงพืชกลุ่มนี้ ให้ทำคู่กับกระปุกคุมที่ใช้วิธีมาตรฐานเสมอ",
      "เทียบอัตราปนเปื้อนและความเป็นพิษต่อชิ้นพืชกับกระปุกคุม ก่อนเชื่อว่าใช้แทนหม้อนึ่งได้",
    ],
  ...
  sterilize: {
    ...
    actions: [
      // เดิมข้อนี้สั่งให้ผู้ใช้คำนวณเปอร์เซ็นต์เอง ทั้งที่หน้าขั้นนี้มีเครื่องคำนวณที่รับ
      // ค่าฉลากแล้วคืนปริมาตรที่ตวงได้จริงอยู่แล้ว การให้คำนวณซ้ำมือคือการเพิ่มโอกาสพลาด
      // โดยไม่ได้อะไรกลับมา ตัวเลขที่ต้องใช้จึงมาจากช่อง \"ค่าคำนวณล่าสุด\" ทางเดียว
