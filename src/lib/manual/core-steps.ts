...
export const coreSteps: Record<string, ManualStepDef> = {
  ...
  "prep-media": {
    ...
    materials: [
      "MS basal salts",
      "น้ำตาลทราย",
      "ผงวุ้น ใช้ผงวุ้นอาหารที่ขายตามร้านทำขนมได้",
    ...
    actions: [
      ...
      "ชั่งและละลายตามลำดับ MS basal salts (ผงเกลือแร่สำหรับอาหารเลี้ยงเนื้อเยื่อ ไม่ใช่เกลือแกง) แล้วจึงน้ำตาล แล้วจึงฮอร์โมน",
      ...
      "แบ่งลงภาชนะ ติดป้ายรหัสรอบ แล้วเลือกวิธีฆ่าเชื้ออาหารวิธีใดวิธีหนึ่ง",
