...
export const javaMossPack: PlantPack = {
  ...
  mediaRecipes: [
    {
      id: "bcdat-modified",
      title: "อาหาร BCDAT ดัดแปลง (ยืมจาก Vesicularia montagnei)",
      pH: "5.8",
      ingredients: [
        { name: "BCD basal salts", amountPerLiter: 1, unit: "×", note: "เกลือแร่สูตร BCD เจือจางกว่า MS มาก ยืมจากงานตรงพันธุ์ของสกุลอื่น" },
      ...
      evidence: {
        ...
        sourceIds: [],
        searchedAt: "2026-08-08",
        searchQueries: ["Taxiphyllum barbieri micropropagation medium formula"],
        note: "ไม่มีงานที่ระบุสูตรอาหารของสกุลนี้เข้าถึงเนื้อหาได้เลย ยืมกรอบสูตรจาก Vesicularia montagnei ทั้งหมด",
      },
    },
  ],
  sourceIds: [
