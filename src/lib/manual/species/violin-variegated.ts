...
export const violinVariegatedPack: PlantPack = {
  ...
  overrides: {
    cut: {
      ...
      // ต้องคงจำนวนและลำดับข้อให้ตรงกับทรงกลางใน core-steps.ts เพราะ passCriteria ของขั้นนี้
      // บังคับว่า "ทุกชิ้นอยู่ในน้ำ" อยู่แล้ว ถ้า override ตัดข้อเตรียมน้ำกับข้อหย่อนลงน้ำออก
      // เกณฑ์ผ่านจะอ้างถึงขั้นตอนที่ไม่เคยถูกสั่ง และป้ายหัวข้อจะเลื่อนไปคนละข้อ
      actions: [
        "เตรียมภาชนะใส่น้ำสะอาดวางไว้ข้างมือให้เรียบร้อยก่อน แล้วจึงลงมีดครั้งแรก",
        "ตัดยอดอ่อนยาวประมาณ 4 ถึง 5 ซม. จากปลายยอด นับจากปลายยอดลงมา ไม่ใช่จากก้านใบ แล้วตัดใต้ข้อโดยไม่ตัดผ่านตา",
      ...
      executionInstructions: [
        {
          ...
          quantity: "S 1 ใบ · R1–R3 ภาชนะละ 50 mL",
          container: "S · R1 · R2 · R3",
          completion: "ป้ายทุกใบอ่านได้และวางเรียงจาก S ไป R3",
        },
        {
          label: "เตรียมน้ำยาฟอก",
          action: "กรอกเปอร์เซ็นต์และฐานฉลากของ Haiter ในเครื่องคำนวณ แล้วใช้ปริมาณที่ระบบแสดงจริง ห้ามกะเอง",
          quantity: "คลอรีนออกฤทธิ์จุดตั้งต้น 1.0% · ถ้าฉลากเป็น % w/w ให้ใช้ผลเป็นน้ำหนักหรือค่าที่ระบบระบุฐานไว้",
          container: "S",
          completion: "สารละลายอยู่ใน S และมีบันทึกผลิตภัณฑ์/lot/ค่าที่ใช้จริง",
        },
        {
        ...
        ...[1, 2, 3].map((round) => ({
          ...
          action: `เทสารละลายจากรอบก่อนทิ้ง แล้วล้างชิ้นพืชด้วยน้ำปลอดเชื้อใน R${round}`,
