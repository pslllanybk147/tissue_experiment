  ...
  mediaRecipes: [
    {
      ...
      evidence: {
        level: "adapted",
        sourceIds: ["source-vesicularia-montagnei-2023"],
        note: "องค์ประกอบ BCDAT และ sucrose 58 mM ถอดจากวิธีทดลองของงาน Vesicularia montagnei; การใช้กับ Christmas moss ยังเป็นการประยุกต์ และต้องตรวจรูป hydrate ของสารทุกตัวก่อนชั่ง",
      },
    },
  ],
  sourceIds: [
