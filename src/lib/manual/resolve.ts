...
function mediaExecutionInstructions(pack: PlantPack) {
  ...
  return [
    ...
    },
    {
      ...
      action: "ก่อนฆ่าเชื้ออาหารและกระปุก ให้เลือกวิธีที่คุณจะทำจริงในหน้าตั้งค่ารอบ ระบบจะใช้วิธีเดียวกับที่ล็อกไว้ในรอบนี้ตรงขั้นตอนและบันทึกค่าที่ใช้จริงไว้กับรอบ ห้ามเปิดเครื่องคำนวณแยกจาก protocol",
