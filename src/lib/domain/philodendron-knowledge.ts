...
export const philodendronSources: ManualSource[] = [
  ...
  { id: "source-mini-rose-2020", title: "การเพาะเลี้ยงเนื้อเยื่อกุหลาบหนูโดยอาหารเพาะเลี้ยงเนื้อเยื่อพืชอย่างง่าย", url: "https://ph03.tci-thaijo.org/index.php/ajsas/article/view/4003", sourceType: "peer-reviewed", accessedAt: "2026-07-31" },
  { id: "source-cmru-rose-video-2020", title: "การเพาะเลี้ยงเนื้อเยื่อกุหลาบอย่างง่าย — ศูนย์ความเป็นเลิศด้านเทคโนโลยีชีวภาพพืช มรภ.เชียงใหม่", url: "https://www.youtube.com/watch?v=QI9bWN1IkOs", sourceType: "technical-guide", accessedAt: "2026-07-31" },
...
const sharedSteps = (evidenceState: EvidenceState, sourceIds: string[]): ManualStep[] => [
  ...
  step("explant-selection", 4, "เลือกยอด/ข้อ/ตาข้าง", "เลือก explant ที่มีตาเดิมและลายที่ต้องการ", ["ดูข้อและตาข้างจากด้านข้าง ไม่ใช้รูปมุมบนอย่างเดียว", "ทำเครื่องหมายด้านบน/ล่างและหมายเลขข้อ", "สำหรับต้นแม่ราคาแพง ให้เริ่มตัดทดลอง 1 explant ก่อน เพื่อลดความเสี่ยง แต่จำนวนกระปุกอาหารไม่เท่ากับจำนวน explant: ต้องเตรียมกระปุกเพาะ 1 กระปุก, Blank control 1 กระปุก และกระปุกสำรอง 1–2 กระปุก"], ["รูปด้านข้าง", "ป้ายหมายเลขข้อ", "ไม้บรรทัด"], ["ต้องเหลือข้อสำรองบนต้นแม่", "หลีกเลี่ยงข้อที่ช้ำหรือใกล้วัสดุปลูกมาก"], ["ใช้ใบมีดอย่างปลอดภัย"], "ระบุตำแหน่งตัดบนภาพได้", ["มีรูปพร้อมหมายเลขข้อ", "มีตาชัด"], ["ไม่มีตาหรือชิ้นส่วนเสียหาย"], "Adapted", sourceIds),
