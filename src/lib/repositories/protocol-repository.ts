...
export type ProtocolAuditEvent = { id: string; protocolId: string; ownerId: string; action: "created" | "updated" | "version_created" | "activated" | "archived"; occurredAt: string; before: Record<string, unknown> | null; after: Record<string, unknown> | null };
